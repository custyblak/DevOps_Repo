...
# Date: 25/05/2024
#
# This script pulls notifies the specified Github repository admin of new issues
#
# Version: v1
##############################################
...
check_issue
alert_admin  $new_issues  # Pass new_issues as an argument
